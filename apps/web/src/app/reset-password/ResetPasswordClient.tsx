  ...
  if (!token) {
    return (
      <div className="text-center">
        ...
        <p className="mt-2 text-sm text-[var(--v2-muted)]">Please use the link from your password reset email.</p>
        <Link
  ...
  if (status === "success") {
    return (
      <div className="text-center">
        ...
        <p className="mt-2 text-sm text-[var(--v2-muted)]">You can now log in with your new password.</p>
        <Link
          href="/login"
          className="mt-6 inline-block rounded-lg bg-[var(--v2-accent)] px-5 py-2 text-xs font-medium text-white transition hover:brightness-110"
        >
          Go to login
        </Link>
      </div>
  ...
  return (
    <div>
      <div className="text-center">
        ...
        <p className="mt-2 text-sm text-[var(--v2-muted)]">Choose a strong password (min 8 characters).</p>
      </div>

      <div className="mt-6 rounded-xl border border-[var(--v2-border)] bg-[var(--v2-surface)] p-4">
        <label className="text-[10px] font-semibold uppercase tracking-wider text-[var(--v2-muted)]">New password</label>
        <input
          value={pw}
        ...
        <label className="mt-4 block text-[10px] font-semibold uppercase tracking-wider text-[var(--v2-muted)]">Confirm password</label>
        <input
          value={pw2}
        ...
        {pw2 && pw !== pw2 ? <div className="mt-2 text-xs text-[var(--v2-warn)]">Passwords do not match.</div> : null}
