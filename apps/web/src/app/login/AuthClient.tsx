  ...
  return (
    <div className="w-full">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        {mode === "login" && authNotice && (
          <div className="relative overflow-hidden rounded-2xl border border-[var(--v2-border)] bg-[var(--v2-surface-2)] px-3 py-3 text-[13px] text-[var(--v2-text)]">
            <div className="flex items-start gap-3">
              <div className="mt-0.5 flex h-9 w-9 items-center justify-center rounded-xl border border-[var(--v2-border)] bg-[var(--v2-surface)] text-[var(--v2-accent)]" aria-hidden>
              ...
              <div className="min-w-0">
                <div className="text-[10px] font-extrabold uppercase tracking-[0.22em] text-[var(--v2-muted)]">Sign-in required</div>
                <div className="mt-0.5 leading-snug font-semibold text-[var(--v2-text)]">{authNotice}</div>
              </div>
            </div>
          </div>
        )}
        ...
        {error && (
          <div
            className="relative overflow-hidden rounded-2xl border border-[var(--v2-border)] bg-[var(--v2-down-bg)] px-3 py-3 text-[13px] text-[var(--v2-text)]"
          >
            <div className="flex items-start gap-3">
              <div className="mt-0.5 flex h-9 w-9 items-center justify-center rounded-xl border border-[var(--v2-border)] bg-[color-mix(in_srgb,var(--v2-down)_10%,transparent)] text-[var(--v2-down)]" aria-hidden>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
