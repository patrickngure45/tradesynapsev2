...
export const metadata: Metadata = {
  title: `Arcade Transparency | ${BRAND_NAME}`,
  description: "Audit-friendly stats and distributions for Arcade outcomes.",
};
        ...
        <section className="relative mb-6 overflow-hidden rounded-2xl border border-[var(--border)] bg-[var(--card)] shadow-[var(--shadow)]">
          ...
          <div className="relative p-6 md:p-8">
            <div className="flex items-center gap-3">
              ...
              <div className="text-[11px] font-bold uppercase tracking-widest text-[var(--muted)]">Transparency</div>
              <div className="h-px flex-1 bg-[var(--border)]" />
            </div>

            <h1 className="mt-3 text-3xl font-extrabold tracking-tight text-[var(--foreground)] md:text-4xl">
              Outcome <span className="bg-gradient-to-r from-[var(--accent)] to-[var(--accent-2)] bg-clip-text text-transparent">Stats</span>
            </h1>

            <p className="mt-3 max-w-2xl text-[15px] leading-relaxed text-[var(--muted)]">
              See your personal distributions converge over time. This replaces “trust the house.”
            </p>
          </div>
        </section>
